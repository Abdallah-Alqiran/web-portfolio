import{e as x,j as r}from"./index-CC49xmI8.js";import{u as p}from"./firestore-zOf3FFaU.js";import{m as f}from"./proxy-DKKfmXrN.js";import"./firebase-DMW8btrb.js";const g=()=>{const e=x.c(8),{isLoading:m,error:d,data:l}=p();if(m){let t;return e[0]===Symbol.for("react.memo_cache_sentinel")?(t=r.jsx("p",{className:` bg-secondary text-center text-2xl font-semibold\r

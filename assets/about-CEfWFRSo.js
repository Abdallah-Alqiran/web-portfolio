import{e as x,j as r}from"./index-Icqpd9aF.js";import{u as p}from"./firestore-D4fAQXi2.js";import{m as f}from"./proxy-YCY90uS8.js";import"./firebase-DMW8btrb.js";const g=()=>{const e=x.c(8),{isLoading:m,error:d,data:l}=p();if(m){let t;return e[0]===Symbol.for("react.memo_cache_sentinel")?(t=r.jsx("p",{className:` bg-secondary text-center text-2xl font-semibold\r
